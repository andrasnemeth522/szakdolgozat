    ...
    <body>
        <div class="bg-white">
            ...
            <header class="relative bg-primary">
                <div class="flex h-15 items-center justify-center bg-secondary">
                    @if(Route::has('login'))
                        <div class="hidden lg:flex lg:flex-1 lg:items-center lg:ml-10 lg:space-x-6">
                            @auth
                                <a
                                    href="{{ url('/dashboard') }}"
                                    class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal"
                ...
                <div class="flex h-25 items-center justify-center bg-base-100 px-4 text-sm font-medium color-secondary-content sm:px-6 lg:px-8">
                    <!-- Logo -->
                    ...
                    <div class="ml-4 flow-root lg:ml-6">
                        <a href="#" class="group -m-2 flex items-center p-2">
                            <svg class="size-6 shrink-0 text-primary group-hover:text-secondary" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
